              ...
              {listingLoading ? (
                ...
                paginatedData.map((p, index) => (
                  ...
                  >
                    ...
                    <TableCell className="px-3 py-2">
                      <Badge className={getStockBadge(p.stock)}>
                        {p.product_types?.product_type_name}
                      </Badge>
                    </TableCell>
                    <TableCell className="px-3 py-2">
                    ...
                    <TableCell className="px-3 py-2">
                      {p?.vendors?.vendor_name}
                    </TableCell>
                    <TableCell className="px-4 py-2 text-center">
                      <Badge
                        className={`cursor-pointer px-3 py-1 rounded-full font-medium shadow-sm ${getStatusBadge(p.status)}`}
                        onClick={() =>
                          handleChangeStatus(p.product_id, p.status)
                        }
                      >
        ...
        <Dialog open={showMedia} onOpenChange={setShowMedia}>
          <DialogContent className="w-full max-w-6xl h-[85vh] p-0 overflow-hidden flex flex-col">
            <DialogHeader className="px-6 pt-6 pb-3 border-b bg-white shrink-0">
              <DialogTitle>Product Media Gallery</DialogTitle>
              <DialogDescription>
                View all media files for this product
              </DialogDescription>
            </DialogHeader>
